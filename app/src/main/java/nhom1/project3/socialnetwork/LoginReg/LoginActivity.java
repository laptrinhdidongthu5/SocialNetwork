package nhom1.project3.socialnetwork.LoginReg;
...
import nhom1.project3.socialnetwork.ForgotPassword.ForgotPassActivity;
import nhom1.project3.socialnetwork.Home.MainActivity;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        copyrightTV.setText("it1006 © " + year);
                                ...
                                userDatabaseReference.child(userUID).child("device_token").setValue(userDeiceToken)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                Log.d("it10069", "Checking!!!");
                                                checkVerifiedEmail();
                                                Log.d("it10069", "CheckVerfied!!!");
                                            }
                                        });
                            } else {
